            ...
            try
            {
                ...
                if (Session["ImageFile"] != null)
                {
                    ...
                    if (file != null && file.ContentLength > 0)
                    {
                        ...
                        //string newFileName = maxId + "_" + fileName + extension;
                        //string savepath = "~/Documents/Holders/Images/" + newFileName;

                        //string newpath = Path.Combine(Server.MapPath("~/Documents/Holders/Images/"), newFileName);
                        //file.SaveAs(newpath);

                        //string baseFolder = CommonConstantHelper.DevRootDirectoryFaisal + "/Documents/Holders/Images/" + newFileName;
                        holder.ImageLocation = string.Empty;
                    }
                    else
                    {
                        status = "ppsize_image";
