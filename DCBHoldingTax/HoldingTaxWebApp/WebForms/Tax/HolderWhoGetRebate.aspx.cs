...
{
    public partial class HolderWhoGetRebate : System.Web.UI.Page
    {
        ...
        private void cryreportshow()
        {
            ...
            cryRpt.Load(Server.MapPath("~/AppReports/Tax/crHolderWhoGetRebate.rpt"));
            cryRpt.SetDatabaseLogon("sa", "#PimsOne$1m#", @"119.18.146.107", "DCB_HTAS");

            CrystalReportViewer1.ReportSource = cryRpt;

            dsForRebate rebateData = Getdata(); // datasetname
            cryRpt.SetDataSource(rebateData);
        ...
        private dsForRebate Getdata()    /*-----Return type is Dataset--------*/
        {
            ...
            SqlCommand cmd = new SqlCommand("exec [rpt].[spHoldersWhoGetRebate] @FinancialYearId, @AreaId, @PlotId", con);
