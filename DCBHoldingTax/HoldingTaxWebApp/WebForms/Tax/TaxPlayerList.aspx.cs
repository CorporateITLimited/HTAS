...
{
    public partial class TaxPlayerList : System.Web.UI.Page
    {
        ...
        private void cryreportshow()
        {
            ...
            cryRpt.Load(Server.MapPath("~/AppReports/Tax/rptTaxPlayers.rpt"));
        ...
        private dsTax Getdata()    /*-----Return type is Dataset--------*/
        {
            ...
            SqlCommand cmd = new SqlCommand("exec [rpt].[spTaxPayerHolders] @FinancialYearId, @AreaId", con);
