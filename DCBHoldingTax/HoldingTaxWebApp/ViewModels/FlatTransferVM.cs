...
{
    public class FlatTransferVM
    {
        public int HolderId { get; set; }

        [Display(Name = "ফ্ল্যাট/বাড়ী মালিকের নাম")]
        ...
        [Display(Name = "ফ্ল্যাট হস্তান্তরের রেফারেন্স")]
        public string TransferRefNo { get; set; }

        [Display(Name = "ফ্ল্যাট হস্তান্তরের তারিখ ")]
        public DateTime? TransferRefDate { get; set; }
