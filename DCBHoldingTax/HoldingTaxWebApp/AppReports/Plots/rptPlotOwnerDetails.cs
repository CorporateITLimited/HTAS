...
namespace HoldingTaxWebApp.AppReports.Plots {
    using System;
    ...
    public class rptPlotOwnerDetails : ReportClass {
        
        public rptPlotOwnerDetails() {
        }
        
        public override string ResourceName {
            get {
                return "rptPlotOwnerDetails.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "HoldingTaxWebApp.AppReports.Plots.rptPlotOwnerDetails.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptPlotOwnerDetails : Component, ICachedReport {
        
        public CachedrptPlotOwnerDetails() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptPlotOwnerDetails rpt = new rptPlotOwnerDetails();
            rpt.Site = this.Site;
            return rpt;
        }
