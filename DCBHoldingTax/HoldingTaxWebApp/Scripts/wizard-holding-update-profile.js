...
var KTWizard4 = function () {
    ...
    var _initWizard = function () {
        ...
        _wizardObj.on('submit', function (wizard) {
            ...
            Swal.fire({
                text: "আপনি কি আপনার ব্যাক্তিগত তথ্য বা ফ্ল্যাট নম্বর হালনাগাদ চান?",
                icon: "success",
                ...
                if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function (d) {
                                if (d.status === "success") {
                                    ...
                                    Swal.fire({
                                        text: "আপনার প্রদানকৃত তথ্যাবলী অ্যাডমিন এর অনুমতির জন্য প্রক্রিয়াধীন অবস্থায় রয়েছে।",
                                        icon: "success",
                                        buttonsStyling: false,
                                    ...
                                    setTimeout(function () { window.location.href = "/HolderClient/HolderProfile"; }, 2000);
                                }
                    ...
                    Swal.fire({
                        text: "আপনার প্রদানকৃত তথ্যাবলীর সাবমিশন বাতিল করা হয়েছে",
                        icon: "error",
                        buttonsStyling: false,
